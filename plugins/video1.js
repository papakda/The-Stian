    ...
    execute: async (sock, m, {
        ...
        try {
            ...
            await sock.sendMessage(m.chat, {
                ...
                contextInfo: {
                    externalAdReply: {
                        title: "🎬 The Stian Video",
                        body: "Click for more downloads!",
                        mediaType: 2,
                        thumbnailUrl: thumbnail,
                        sourceUrl: "https://whatsapp.com/channel/0029VbBz2HC0G0XatbyjGQ3m"
                    }
                }
            }, { quoted: m });
