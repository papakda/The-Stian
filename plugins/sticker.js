...
module.exports = {
    ...
    execute: async (sock, m, params) => {
        ...
        try {
            // Check if there's media to convert
            let targetMessage = m;
            ...
            if (!mediaMessage) {
                return await reply(
                    'Please reply to an image/video with .sticker\n\n> 𝐓𝐇𝐄 𝐒𝐓𝐈𝐀𝐍'
                );
            }
            ...
            const json = {
                ...
                'sticker-pack-name': 'THE STIAN',
                'sticker-pack-publisher': 'THE STIAN',
                'emojis': ['🤖']
            };
            ...
            await reply('❌ Failed to create sticker! Make sure the media is an image or video.');
        }
    }
};